  ...
  return (
    <div className="header">
      ...
      <div className="header__nav">
        ...
        <div className="header__option">
          <span className="header__optionLineOne">Member's</span>
          <span className="header__optionLineTwo">Ship</span>
        </div>

        <Link to="/profile">
          <div className="header__option">
            <span className="header__optionLineOne header__profile">
              <AccountCircleIcon />
            </span>
            <span className="header__optionLineTwo header__profiletext">
              Profile
            </span>
          </div>
        </Link>
        ...
        <Link to="/checkout">
          <div className="header__optionBasket ">
            <span className=" header__basketCount">
              <span className="header__basketno">{basket?.length}</span>
              <ShoppingCartOutlinedIcon />
            </span>
            <span className="basket__text">Cart</span>
          </div>
        </Link>
      </div>
    </div>
